...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, -1 /* CACHED */)]))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, _ctx.showScrollTop]])], 6 /* CLASS, STYLE */), _cache[175] || (_cache[175] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" t", -1 /* CACHED */))], 64 /* STABLE_FRAGMENT */);
}
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    startVoiceSearch() {
      ...
      if (!this.speechRecognitionSupported || !this.speechRecognitionInstance) {
        this.speechRecognitionError = "Voice search is not supported in this browser.";
        return;
      }
      this.speechRecognitionError = "";
      try {
        ...
        const name = String((error === null || error === void 0 ? void 0 : error.name) || "");
        if (name === "InvalidStateError") return;
        this.speechRecognitionError = "Unable to start voice search right now.";
      }
    },
    stopVoiceSearch() {
      if (!this.speechRecognitionInstance) return;
    ...
    getAdvancedSearchEditions(query) {
      ...
      const ordered = hasArabic ? ["quran-uthmani", translationId, transliterationId] : [translationId, transliterationId, "quran-uthmani"];
    ...
    async hydrateAdvancedSearchMatches(matches, translationId, transliterationId, signal) {
      ...
      responses.forEach(result => {
        ...
        payloadBySurah.set(result.value.surahNumber, result.value.payload);
      });
    ...
    async runAdvancedSearch(options = {}) {
      ...
      try {
        ...
        const requests = editions.map(async edition => {
          ...
          const payload = await this.fetchAdvancedSearchJSON(endpoint, `cache:advanced-search:query:${edition}:${normalizedQuery}`, 3 * 60 * 60 * 1000, signal);
          return {
            edition,
            payload
          };
