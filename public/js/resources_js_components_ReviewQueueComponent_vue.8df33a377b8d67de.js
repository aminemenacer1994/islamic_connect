...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted() {
    ...
    (0,_scripts_memorisationTracking__WEBPACK_IMPORTED_MODULE_1__.trackEventOnce)("review_queue_opened", {
      ...
      dedupeKey: `review_queue_opened:${this.currentUserId}:${Date.now()}`
    });
...
function trackEventOnce(name, payload = {}, options = {}) {
  ...
  // Debug visibility without performance impact (no stringification loops).
  try {
    // eslint-disable-next-line no-console
    console.info("[memorisation_event]", eventName, event.payload);
  } catch (_) {}
  return true;
}
