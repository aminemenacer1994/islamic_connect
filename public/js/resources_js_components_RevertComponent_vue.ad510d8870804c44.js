...
const CHAPTER_TOOL_MAP = {
  4: createChapterToolEntry({
    ...
    icon: 'bi-menu-book',
    loader: () => __webpack_require__.e(/*! import() */ "resources_components_vue_SuratComponent_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./SuratComponent.vue */ "./resources/components/vue/SuratComponent.vue")),
    route: '/surat'
  }),
