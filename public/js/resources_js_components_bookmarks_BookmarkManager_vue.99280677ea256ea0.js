  ...
  methods: {
    ...
    async fetchCurrentBookmark() {
      ...
      try {
        ...
        const rawFolders = (bookmark === null || bookmark === void 0 ? void 0 : bookmark.folders) || [];
        const rawFolderIds = (bookmark === null || bookmark === void 0 ? void 0 : bookmark.folder_ids) || (bookmark === null || bookmark === void 0 ? void 0 : bookmark.folderIds) || [];
        let extractedIds = [];
    ...
    async saveBookmark() {
      ...
      this.isSaving = true;
      try {
        var _this$currentBookmark7, _this$currentBookmark8, _this$currentBookmark9, _this$ayah$surah, _this$ayah$ayah, _response$data4, _this$currentBookmark0;
        this.normalizeSelectedFolders();
        const selectedIds = Array.from(new Set(this.selectedFolderIds.map(Number).filter(id => Number.isFinite(id) && id > 0)));
        const rawFolders = ((_this$currentBookmark7 = this.currentBookmark) === null || _this$currentBookmark7 === void 0 ? void 0 : _this$currentBookmark7.folders) || [];
        const rawFolderIds = ((_this$currentBookmark8 = this.currentBookmark) === null || _this$currentBookmark8 === void 0 ? void 0 : _this$currentBookmark8.folder_ids) || ((_this$currentBookmark9 = this.currentBookmark) === null || _this$currentBookmark9 === void 0 ? void 0 : _this$currentBookmark9.folderIds) || [];
        let existingIds = [];
        if (Array.isArray(rawFolders) && rawFolders.length > 0) {
        ...
        if (removableIds.length && (_this$currentBookmark0 = this.currentBookmark) !== null && _this$currentBookmark0 !== void 0 && _this$currentBookmark0.id) {
          try {
    ...
    async removeAyahFromFolder(bookmark, folder) {
      ...
      try {
        var _this$folderContents$2, _this$currentBookmark1;
        ...
        if (((_this$currentBookmark1 = this.currentBookmark) === null || _this$currentBookmark1 === void 0 ? void 0 : _this$currentBookmark1.id) === bookmark.id) {
          this.selectedFolderIds = this.selectedFolderIds.filter(id => id !== folder.id);
        }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Teleport, {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: folder.id,
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["folder-pill-container", [folder.color ? `pill-${folder.color}` : 'pill-neutral', {
    ...
    }, null, 2 /* CLASS */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("i", _hoisted_38))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_39, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_40, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(folder.name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_41, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(folder.ayah_count || 0) + " saved", 1 /* TEXT */)]), _cache[27] || (_cache[27] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      class: "pill-check",
      "aria-hidden": "true"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("i", {
      class: "bi bi-check-lg"
    })], -1 /* CACHED */))], 8 /* PROPS */, _hoisted_36), !folder.is_smart ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: 0,
      type: "button",
      class: "pill-delete",
      ...
      class: "bi bi-trash3",
      "aria-hidden": "true"
    }, null, -1 /* CACHED */)]))], 8 /* PROPS */, _hoisted_42)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */);
