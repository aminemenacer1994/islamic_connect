        ...
        <div class="mx-auto mb-4 next-step-card">
          ...
          <div class="d-flex align-items-start gap-3 text-start">
            <div class="flex-shrink-0 mt-1">
              <div class="next-step-icon-circle" role="img" aria-label="Gentle Hijri date guide">
            ...
            <div class="flex-grow-1">
              ...
              <div v-show="nextStepMinimized" class="mb-2 d-inline-flex align-items-center gap-1 next-step-teaser">
                <a href="/calendar" class="fw-semibold text-decoration-none d-inline-flex align-items-center gap-1 next-step-link"
              ...
              <p v-show="!nextStepMinimized" class="mb-3 next-step-text">
                ...
                <a href="/calendar" class="fw-semibold text-decoration-none next-step-link">
                  Visit Hijri Calendar
                </a>
                whenever you want to see the bigger picture.
              </p>
              <div v-show="!nextStepMinimized" class="d-flex flex-wrap gap-2">
                <a href="/calendar" class="btn btn-sm fw-semibold text-white px-3 py-2 d-inline-flex align-items-center next-step-cta">
        ...
        <div class="col-12 col-md-12 col-lg-10">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div v-if="convertedDate" class=" d-flex justify-content-center align-items-center mt-5 mb-5">
                <div class="result-card w-100"
                  ...
                  <div class="d-flex justify-content-center">
                    <table class="table w-auto bg-white mb-0 calendar-table" role="table"
                      style="border-radius: 0.75rem; overflow: hidden; border: 1px solid #e0e0e0;">
                      <caption class="text-muted">Islamic calendar month grid showing days of week and Hijri dates
                      </caption>
                      <thead>
                        <tr role="row">
                          <th v-for="day in weekdaysShort" :key="day" class="text-center small" scope="col"
                            style="background: #f8f9fa;">{{ day }}</th>
                        </tr>
                      </thead>
                      <tbody>
...
.alert-islamic .alert-close:hover {
  opacity: 0.95;
}
