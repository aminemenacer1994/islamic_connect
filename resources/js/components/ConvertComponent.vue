<template>
  <div class="container py-4 convert-bg text-black">
    ...
    <div class="text-center mb-5 fade-in">
      <h1 class="display-5 fw-bold" style="color: #00bfa6">Welcome, New Muslim!</h1>
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h2 class="card-title mb-0"><i class="bi bi-bar-chart-steps me-2" style="color:#00bfa6"></i>Your Journey Progress</h2>
        ...
        <div class="mb-3">
          <div class="progress" style="height: 30px;">
            <div class="progress-bar" :style="{width: progressPercent + '%', backgroundColor: '#00bfa6'}" role="progressbar" :aria-valuenow="progressPercent" aria-valuemin="0" aria-valuemax="100">
              {{ progressPercent }}%
            </div>
          </div>
        </div>
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h2 class="card-title mb-0"><i class="bi bi-chat-quote-fill me-2" style="color:#00bfa6"></i>Testimonials</h2>
          ...
          <div class="carousel-inner">
            <div v-for="(testimonial, i) in testimonials" :key="i" :class="['carousel-item', {active: i === testimonialIndex}]">
              <div class="d-flex flex-column align-items-center">
                <img :src="testimonial.avatar" class="rounded-circle mb-3" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid #00bfa6;">
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body">
        <h2 class="card-title mb-3"><i class="bi bi-question-circle-fill me-2" style="color:#00bfa6"></i>Islam Basics Quiz</h2>
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body">
        <h2 class="card-title mb-3"><i class="bi bi-journal-richtext me-2" style="color:#00bfa6"></i>Resources</h2>
        <div class="row row-cols-1 row-cols-md-2 g-4">
          <div class="col" v-for="(resource, i) in resources" :key="i">
            <div class="card h-100 border-0">
              <div class="card-body">
                <h5 class="card-title"><i :class="resource.icon" class="me-2" style="color:#00bfa6"></i>{{ resource.title }}</h5>
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body">
        <h2 class="card-title mb-3"><i class="bi bi-question-circle-fill me-2" style="color:#00bfa6"></i>Need Help?</h2>
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body">
        <h2 class="card-title mb-3"><i class="bi bi-calendar-event-fill me-2" style="color:#00bfa6"></i>Upcoming Events</h2>
        <ul class="list-group">
          <li v-for="(event, i) in events" :key="i" class="list-group-item d-flex justify-content-between align-items-center bg-white text-black">
            <span><i class="bi bi-calendar2-week me-2" style="color:#00bfa6"></i>{{ event.title }}</span>
    ...
    <div class="card mb-5 shadow-sm convert-card fade-in">
      <div class="card-body text-center">
        <h2 class="card-title mb-3" style="color:#00bfa6"><i class="bi bi-megaphone-fill me-2"></i>Get Involved!</h2>
