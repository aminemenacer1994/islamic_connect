        ...
        <div class="col-md-6">
          <div class="d-flex">
            ...
            <div>
              ...
              <p>Capture your spoken reflections, making it easier to document your thoughts and reflections on Islamic teachings, while ensuring accessibility for those who prefer audio to written text.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex">
            ...
            <div>
              ...
              <p>Effortlessly search Quranic verses, teachings, and guidance using your voice. Experience a seamless, accessible way to connect with Islam.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex">
            ...
            <div>
              ...
              <p>A powerful and adaptable note editor designed to meet diverse user needs, combining advanced editing capabilities with extensive customization options. This tool emphasizes seamless accessibility.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex">
            ...
            <div>
              ...
              <p>Easily export Quranic verses in multiple formats for study, research, and sharing, offering flexibility and convenience for personal reflection or educational purposes.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex">
            ...
            <div>
              ...
              <p>Enhance the Quranic recitation experience by synchronizing the audio with the Quranic text. Each word is highlighted as it is recited, helping users follow along with the pronunciation and meaning of the words.</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex">
            ...
            <div>
              ...
              <p>High-quality, spoken translations and Tafsir of the Quranic verses, making the Divine message more accessible, gaining a clearer understanding of the meanings and scholarly interpretations of the Quran and enriching connection to the sacred text.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="card border-0 border-bottom shadow-lg pb-md-4 bsb-pricing-popular">
            <div class="card-body">
              ...
              <button class="w-100 btn button" style="background: rgb(0 163 164); color:white" role="button"><span style="color:white;font-size:19px;box-shadow:">Get Started</span></button>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-6">
          <div class="card border-0 border-bottom shadow-lg pb-md-4 bsb-pricing-popular" style="border:2px solid rgba(151, 65, 252, 0.2) 0 15px 30px -5px;">
            <div class="card-body">
              <div style="padding:20px">
              ...
              <div class="row">
                <div class="col-md-6">
                  <button 
                    class="w-100 btn button mb-2" 
                    style="background:rgb(0 163 164);color:white" 
                    role="button" 
                  >
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="row modal-body">
                  <p class="mb-2 mt-2 container text-center">This is a matter between you and your Lord. If you sincerely need access to the premium version but cannot afford it, Islamic Connect is here to support you. We will provide you with the premium features at no cost, ensuring nothing stands in the way of your spiritual journey.</p>
                  <div class="col-md-6">
                    <button class="w-100 btn button" style="background:rgb(0 163 164);color:white" role="button" @click="subscribe('free_monthly')"><span style="color:white;font-size:16px;"><b>Monthly Plan</b></span></button>
                  </div>
                  <div class="col-md-6">
                    <button class="w-100 btn button" style="background:rgb(0 163 164);color:white" role="button" @click="subscribe('free_yearly')"><span style="color:white;font-size:16px;"><b>Yearly Plan</b></span></button>
                  </div>
                </div>
            ...
            <div class="col-lg-12">
              <div class="accordion" id="Tech-accordion">
                <div class="accordion-item">
                  ...
                  <div aria-labelledby="Tech-headingOne" class="accordion-collapse collapse" data-bs-parent="#Tech-accordion" id="Tech-collapseOne">
                    <div class="accordion-body">
                      No, there are no hidden fees. The subscription price you see includes all features, with no unexpected charges.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  ...
                  <div aria-labelledby="Tech-headingTwo" class="accordion-collapse collapse" data-bs-parent="#Tech-accordion" id="Tech-collapseTwo" style="">
                    <div class="accordion-body">
                      If you cancel your subscription, you will retain access to the premium features until the end of your billing cycle, after which your account will revert to the free version.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  ...
                  <div aria-labelledby="Tech-headingFour" class="accordion-collapse collapse" data-bs-parent="#Tech-accordion" id="Tech-collapseFour">
                    <div class="accordion-body">
                      Currently, we do not offer lifetime subscriptions, but we provide competitive annual plans that deliver ongoing value.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="Tech-headingFive"><button aria-controls="Tech-collapseFive" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#Tech-collapseFive" data-bs-toggle="collapse" type="button">
                      <div class="text-muted me-3">
                        <svg class="bi bi-question-circle-fill" fill="currentColor" height="24" viewbox="0 0 16 16" width="24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z"></path>
                        </svg>
                  ...
                  <div aria-labelledby="Tech-headingFive" class="accordion-collapse collapse" data-bs-parent="#Tech-accordion" id="Tech-collapseFive">
                    <div class="accordion-body">
                      Yes, subscriptions are automatically renewed to ensure uninterrupted access, but you can cancel or manage your subscription at any time.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="Tech-headingSix"><button aria-controls="Tech-collapseSix" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#Tech-collapseSix" data-bs-toggle="collapse" type="button">
                      <div class="text-muted me-3">
                        <svg class="bi bi-question-circle-fill" fill="currentColor" height="24" viewbox="0 0 16 16" width="24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z"></path>
                        </svg>
                  ...
                  <div aria-labelledby="Tech-headingSix" class="accordion-collapse collapse" data-bs-parent="#Tech-accordion" id="Tech-collapseSix">
                    <div class="accordion-body">
                      Yes, we offer a free trial period to help you explore all premium features before committing to a subscription.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="Tech-headingSeven"><button aria-controls="Tech-collapseSeven" aria-expanded="false" class="accordion-button collapsed" data-bs-target="#Tech-collapseSeven" data-bs-toggle="collapse" type="button">
                      <div class="text-muted me-3">
                        <svg class="bi bi-question-circle-fill" fill="currentColor" height="24" viewbox="0 0 16 16" width="24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z"></path>
                        </svg>
                  ...
                  <div aria-labelledby="Tech-headingSeven" class="accordion-collapse collapse" data-bs-parent="#Tech-accordion" id="Tech-collapseSeven">
                    <div class="accordion-body">
                      Your payment information is securely encrypted and processed through a trusted payment gateway to ensure maximum security.
                    </div>
                  </div>
                </div>
