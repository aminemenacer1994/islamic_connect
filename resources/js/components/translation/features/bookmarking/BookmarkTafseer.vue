...
export default {
  ...
  methods: {
    ...
    async submitForm2() {
      const { surah, ayah_text, ayah_id, tafseer } = this.information;

      if (!surah || !ayah_text || ayah_id === null || !tafseer) {
