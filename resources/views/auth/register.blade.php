                      ...
                      <div class="row ">
                        <div class="col w-100">
                          <!-- <button onclick="window.location.href='{{ url('auth/google') }}'">
                           <img src="images/mGHPI.png" class="w-100" width="50px"/>
                          </button> -->
                          <button onclick="window.location.href='{{ url('auth/google') }}'" class="gsi-material-button">
                        ...
                        <!-- <div class="col">
                          <button onclick="window.location.href='{{ url('auth/facebook') }}'">
                           <img src="images/4LSMF.png" class="w-100" width="50px"/>
                          </button>
                        </div> -->
                      </div>
                    </div>
